    ...
    <>
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-[11px] text-slate-500 max-w-50 truncate">{meal.description}</p>
                          </div>
                        </div>
                      </td>
      ...
      {modalOpen && (
        <Modal
          ...
          subtitle="Documenta la tua indulgenza culinaria con precisione e stile."
          size="lg"
          footer={
                ...
                >
                  {imagePreview ? (
                    ...
                    <div className="flex h-32 w-full flex-col items-center justify-center">
                      ...
                      <p className="mt-2 text-[14px] font-medium text-slate-700">Carica la foto</p>
                      <p className="mt-1 text-[11px] text-slate-400">JPEG, PNG, WebP</p>
                    </div>
                  )}
                </button>
              </div>
